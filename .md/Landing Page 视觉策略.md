...
> 文档版本：v1.0
> 创建日期：2026-03-04
> 关联文档：项目框架结构.md、项目执行规范.md、差距分析报告.md
...
:root {
  ...
  --landing-text-primary: rgba(255, 255, 255, 0.90);
  --landing-text-secondary: rgba(255, 255, 255, 0.60);
  --landing-text-tertiary: rgba(255, 255, 255, 0.40);
...
export function createScrollReveal(selector: string, options?: {
  threshold?: number
  stagger?: number
  translateY?: number
  duration?: number
