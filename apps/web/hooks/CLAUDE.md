...
use-agent-session.ts     — useAgentSession Agent 会话编排 (summary -> multi-plan|template-plan|diagnose|optimize|explain -> prompt refine/confirm -> apply -> run，含短期创作记忆、方案切换与右侧提案/左侧落图桥接)
