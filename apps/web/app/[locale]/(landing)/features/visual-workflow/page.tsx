 ...
 * [OUTPUT]: 对外提供 /features/visual-workflow 公开功能细分页
 * [POS]: features 子树的可视化工作流说明页，被 sitemap 与功能总览页消费
...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: 'landing.publicPages.visualWorkflow',
  })
...
export default async function VisualWorkflowPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
