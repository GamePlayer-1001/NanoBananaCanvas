/**
 * [INPUT]: 依赖 @clerk/nextjs 的 SignUp，依赖 @clerk/nextjs/server 的 auth，
 ...
 * [OUTPUT]: 对外提供注册页路由，并在已登录时服务端直跳目标页
 * [POS]: (auth) 路由组的注册页入口，复用认证双栏壳层并挂载真实 Clerk 注册卡片，同时拦截已登录访问避免客户端慢跳
