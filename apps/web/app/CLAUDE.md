...
[locale]/(landing)/page.tsx                 — Landing 首页 (HeroSection + models/features/pricing/proof/faq/cta + LandingFooter)
[locale]/(landing)/features/page.tsx        — 功能总览页 (公开页入口)
[locale]/(landing)/models/page.tsx          — 模型生态页 (公开页入口)
[locale]/(landing)/docs/page.tsx            — 文档入口页 (公开资源页)
[locale]/(landing)/contact/page.tsx         — 联系页 (公开资源页 + Organization JSON-LD)
[locale]/(landing)/about/page.tsx           — 关于页 (公开资源页)
...
[locale]/(landing)/refund-policy/page.tsx  — 退款政策 (公开法律资源页)
[locale]/(landing)/acceptable-use/page.tsx — 可接受使用政策 (公开法律资源页)
[locale]/(landing)/cookie-settings/page.tsx — Cookie 设置说明 (公开法律资源页)
...
[locale]/(app)/layout.tsx                   — 应用动态布局 (AppSidebar 200px + main flex-1，contact 已迁出)
