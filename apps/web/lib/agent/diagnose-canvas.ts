 ...
 * [OUTPUT]: 对外提供 diagnoseCanvas()，向服务端请求 AgentDiagnosis
 * [POS]: lib/agent 的诊断语义层，被 use-agent-session 调用
...
export async function diagnoseCanvas(
