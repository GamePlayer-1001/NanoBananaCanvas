...
export const ErrorCode = {
  ...
  BILLING_SUBSCRIPTION_NOT_CANCELABLE: 'BILLING_SUBSCRIPTION_NOT_CANCELABLE',
  BILLING_TRIAL_ALREADY_USED: 'BILLING_TRIAL_ALREADY_USED',
  BILLING_PROVIDER_ERROR: 'BILLING_PROVIDER_ERROR',
  BILLING_RATE_LIMITED: 'BILLING_RATE_LIMITED',
  BILLING_PAYMENT_DECLINED: 'BILLING_PAYMENT_DECLINED',
  BILLING_NETWORK_ERROR: 'BILLING_NETWORK_ERROR',
  BILLING_CREDITS_INSUFFICIENT: 'BILLING_CREDITS_INSUFFICIENT',
...
export class BillingError extends AppError {
  constructor(
    code: Extract<
      ...
      | 'BILLING_SUBSCRIPTION_NOT_CANCELABLE'
