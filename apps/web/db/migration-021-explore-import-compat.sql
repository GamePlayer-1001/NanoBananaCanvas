-- EXPLORE-005: make published_outputs compatible with imported works
...
INSERT INTO published_outputs (
  id, user_id, task_id, workflow_id, source_mode, source_type,
...
SELECT
  ...
  workflow_id,
  'task' AS source_mode,
  'native' AS source_type,
  '' AS source_author_name,
  '' AS source_author_avatar,
  NULL AS import_key,
  '' AS workflow_json_url,
  title,
  description,
  prompt,
  source_url,
