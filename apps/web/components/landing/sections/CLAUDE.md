...
```
section-shell.tsx              — SectionShell 板块外壳，统一 snap section 的满屏背景、标题、描述、宽度与间距
landing-rail.tsx               — LandingRail 右侧节点式滚动导航，暴露 LANDING_SECTION_IDS
model-section.tsx              — ModelSection/ModelMindMapSection 模型动态脑图，中心画布连接 Text/Image/Video/Audio 四簇，并区分当前运行时与生态规划支持
features-pricing-section.tsx   — FeaturesSection 与 PricingSummarySection，承载四张图文视觉功能卡片和首页定价摘要
