...
clerk-provider.tsx — Clerk 路由级 Provider 包装器 (关闭 telemetry，按 locale 固定本地 sign-in/sign-up 与 workspace fallback，显式设置 proxyUrl=/__clerk，前端 API 由 middleware 代理)
