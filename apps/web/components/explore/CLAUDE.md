...
explore-content.tsx: ExploreContent 客户端容器，组合主体下移 128px、圆点叠放在轮播画面上、左右箭头半透明悬浮的无遮罩旋转木马 Banner、去结果统计的两行分类/排序工具区与 Explore API；主类型默认走“全部”，子分类优先按真实分类/节点映射，缺省再兜底关键词筛选
