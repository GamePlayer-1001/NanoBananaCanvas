    ...
    <div className="border-b border-[#d9cf2f] bg-[#fbf44f] text-stone-900">
      <div className="mx-auto flex min-h-[50px] w-full max-w-[1760px] items-center gap-3 px-3 py-1.5 sm:px-5 lg:px-6">
        ...
        <button
          type="button"
          onClick={handleClose}
          className="ml-2 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-stone-700 transition-colors hover:bg-black/5 hover:text-stone-950 sm:ml-3 lg:ml-5"
