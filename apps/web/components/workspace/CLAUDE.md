...
workspace-content.tsx: WorkspaceContent 客户端容器，组合 header + grid + dialog，负责 folder 筛选、创建时继承当前文件夹、搜索/排序/视图应用与多选批量管理
...
new-project-dialog.tsx: NewProjectDialog 创建项目弹窗，支持空白项目与系统模板起手，创建时写入当前文件夹归属，再跳转到全屏画布
