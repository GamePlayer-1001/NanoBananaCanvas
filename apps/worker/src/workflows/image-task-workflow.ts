/**
 * [INPUT]: 依赖 cloudflare:workers 的 WorkflowEntrypoint/WorkflowEvent/WorkflowStep，依赖 ../task-runtime/process-dispatch 的 createWorkerTaskRuntime/WorkerTaskBindings，依赖 ../../../web/lib/tasks 的 processTaskDispatch
...
import { processTaskDispatch } from '../../../web/lib/tasks'
